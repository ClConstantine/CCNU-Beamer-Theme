...
% Author: ChenKai Yao (姚辰恺,  Constantine)                %
% Date:   March 2024.                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item 本项目地址位于 \url{https://github.com/ClConstantine/CCNU-Beamer-Theme}，如果有bug或者feature request可以去提issue
    \end{itemize}
\end{frame}
